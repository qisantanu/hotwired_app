...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { address: @developer.address, dob: @developer.dob, first_name: @developer.first_name, last_name: @developer.last_name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { address: @developer.address, dob: @developer.dob, first_name: @developer.first_name, last_name: @developer.last_name } }
